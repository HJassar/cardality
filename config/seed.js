...
const cards = [
    ...
    { text: "My turn for reading was back and I didnt know where to pick up from, again!" },
    ...
    { text: "...by injected humour, or randomised words which dont look even slightly believable." },
